...
$(function(){
	...
	$('#J_mainCata').on('mouseenter',function(){
		$('#J_subCata').show();
	});
	$('#J_mainCata').on('mouseleave',function(){
		$('#J_mainCata li').removeClass('current');
	});	
	...
	$('.pro_list li img').addClass('hvr-forward');
	$('.ibg').addClass('hvr-grow');
})
