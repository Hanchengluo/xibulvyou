...
<script type="text/javascript" src="themes/<?php echo $GLOBALS['_CFG']['template']; ?>/js/lizi_common_index.js"></script>


<style>

.topimg{width:100%; height:100px; margin:0 auto}
.topimg a img{width:100%; height:100px; margin:0 auto; border:0px}
</style>
<!--<div class="topimg">
	<?php
  ...
  <div class="hd_main cle">
    ...
    <div class="search_box">
      <form action="search.php" method="get" id="searchForm" name="searchForm" onSubmit="return checkSearchForm()">
        <input style="color:#000" class="sea_input" type="text" placeholder="请输入商品名称" name="keywords" id="keyword" value="<?php echo htmlspecialchars($this->_var['search_keywords']); ?>" autocomplete="off">
