...
<div class="w-max ct mb30 clearfix">
    <div class="surprise-tit clearfix" id="surprise">
   ...
   <?php
	...
	?>
	<?php $_from = $this->_var['adlist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_30466800_1486456156');$this->_foreach['ad'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['ad']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_30466800_1486456156']):
        $this->_foreach['ad']['iteration']++;
?>  
	   <?php echo $this->_var['ad_0_30466800_1486456156']['content']; ?>
